...
def load_actions_list_from_file(fn: str) -> list[ActionResource]:
    ...
    result: list[ActionResource] = []
    for raw_action in actions_list:
        action = ActionResource(**raw_action)
        result.append(action)
    return result


def save_actions_to_file(filename: str, actions_list: list[ActionResource]):
