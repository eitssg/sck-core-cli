...
def show_configuration(data):
    ...
    data[P_ITEMS_TABLE_NAME] = items_table_name = get_table_name()
    data[P_EVENTS_TABLE_NAME] = events_table_name = get_table_name()
    data[P_CLIENT_TABLE_NAME] = clients_table = get_table_name()
    data[P_PORTFOLIOS_TABLE_NAME] = portfolios_table = get_table_name()
    data[P_ZONES_TABLE_NAME] = zones_table = get_table_name()
    data[P_APPS_TABLE_NAME] = apps_table = get_table_name()
